    ...
    accueil: `
      <div class="infos">
        <h2>Le séisme d'Al Haouz, le plus puissant jamais enregistré au Maroc</h2>
          <p>Le séisme de 2023 au Maroc ou séisme d'Al Haouz est le plus important tremblement de terre enregistré </p>
          <p> par  des stations sismiques de l'histoire du pays.</p>
          <p style="margin-bottom: 20px;">Le séisme d'Al Haouz, survenu le 8 2023 à 22 h 11 min.</p>
